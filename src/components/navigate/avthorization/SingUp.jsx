  ...
  return (
    <div>
      <div className={styles.singUp}>
        ...
        <input placeholder="Введите никнейм.." type="text" value={name} onChange={(e)=> setName(e.target.value)} />
        ...
        <button onClick={()=> handleRegister(name,login,password)}> Зарегистрироваться</button>
      </div>
    </div>
  );
};
